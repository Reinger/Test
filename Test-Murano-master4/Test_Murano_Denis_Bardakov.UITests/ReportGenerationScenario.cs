...
{
    [TestClass]
    public class ReportGenerationScenario : SeleniumTest
    {
        public ReportGenerationScenario() : base("Test_Murano_Denis_Bardakov") { }
        SqlConnection conn;
        ...
        public static IEnumerable<object[]> Data
        {
            get
            {
                yield return new object[] { new string[][]
                {
                    ...
                    new string[4] { "Иванов", "Менеджер", "не активен", "55000" },
                    new string[4] { "Петров", "Менеджер", "активен", "25000" },
        ...
        public void Report(string[][] employees)
        {
            ...
            ChromeDriver.FindElement(By.CssSelector("li~ li+ li a")).Click();

            Assert.IsTrue(ChromeDriver.Title == "Сохранить отчет - Моя компания");
